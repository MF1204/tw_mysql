...
//	=======================================================
	...
	public int insertMainBoardVO(@Param("bno") int bno, @Param("user_ID") String user_ID, @Param("c_code") int c_code, @Param("boardType") String boardType, @Param("title") String title, @Param("text") String text, @Param("price") int price);

	public int findBno();

	public int insertText(@Param("bno") int bno, @Param("text1") String text1, @Param("text2") String text2, @Param("text3") String text3);

	public int insertY_M_boardVO(@Param("bno") int bno, @Param("rno") int rno, @Param("day1") String day1, @Param("day2") String day2, @Param("exText") String exText, @Param("M_time1") int M_time1, @Param("M_time2") int M_time2, @Param("Money") String Money, @Param("addrBasic") String addrBasic, @Param("addrDetail") String addrDetail, @Param("entX") String entX, @Param("entY") String entY);
	...
	public ArrayList<MainBoardVO> getMainUser_ID (@Param("user_ID") String user_ID);
	...
	public int updateRecomendNum(@Param("bno") int bno,@Param("recomendNum") int recomendNum); // 수정

	public int updateViewNum(@Param("bno") int bno ,@Param("viewNum") int viewNum); // 수정
	
	public V_R_BoardVO getViewNum(@Param("bno") int bno );
