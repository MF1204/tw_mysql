			...
			<div class="col-sm-12" style="float: none; margin: 0 auto; padding: 0; background-color: aquamarine;">
				<div class="header">
					<div class="header-div">
						<a href="${pageContext.request.contextPath}/"> <img src="${pageContext.request.contextPath}/resources/img/mainPageImg/icon_profile.png">
						</a>
					</div>
					<div class="search-tag header-div">
						<form action="searchPage" method="get">
							...
							<span class="btn_img""> <input type="text" class="inner-search" id="inner-search" name="searchName" value="${cri.searchName}">
								<button type="submit" class="btn-search">
									<span class="glyphicon glyphicon-search"></span>
								</button>
							</span> <span class="btn_img search-select"> <select name="searchType2">
							...
							</span> <input type="hidden" name="pageNum" value="1"> <input type="hidden" name="amount" value="12"> <input type="hidden" name="searchType" value="head"> <input type="hidden" name="typeValue" value="1">
