        ...
        <div class="container" style="margin-top: 100px;">
            <div class="row">
                <div class="col-xs-12">
                    <div>
                        <P>
                            <br/>\'ORCTOWN\'은 (이하 \'회사\'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br/>
                            <br/>
                            ...
                            <br/>
                            <br/><br/>■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항
                            <br/>
                            ...
                            <br/><br/>
                            <br/>고객서비스담당 부서 :ORCTOWN
                            <br/>전화번호 : 02-6402-5946
                            <br/><br/>
                            <br/>이메일 : warboss@orctown-store.com
                            <br/><br/>
                            <br/>개인정보관리책임자 성명 : 오태훈
                            <br/>전화번호 : 02-6402-5946
                            <br/>이메일 : warboss@orctown-store.com
                    ...
                    <div style="text-align: center;">
                        <button type="button" class="btn" style="background-color: black; padding-left: 50px; padding-right: 10px; margin: 100px;"   onClick="window.close()">
                            <span style="font-size: xx-large; color: white;">확인</span>
                        </button>
                    </div>
                </div>
            </div>
